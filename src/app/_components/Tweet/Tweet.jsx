  ...
  return (
    <div className='shadow-2xl rounded-lg p-5 bg-[#ffd3a7] flex items-start flex-col w-full lg:w-[450px]'>
      <div className='flex gap-5 items-start'>
        <ProfilePicture size={50} username={petUsername} />
            ...
            <div className='flex flex-col items-start'>
              <div className='flex gap-2 flex-wrap'>
                <p
                  ...
                  onClick={() => {
                    router.push(`/profile/${petUsername}`)
                  }}
                >
                  {petName}
                </p>
      ...
      {showComments &&
        ...
        commentsArray.map((comment, index) => (
          <div className='flex gap-3 mt-5 items-start w-full' key={index}>
            <ProfilePicture size={35} username={comment.pets_username} />
            <div className='flex flex-col items-start'>
              <div className='flex gap-2 flex-wrap '>
                <p
                ...
                <p
                  className='text-neutral-500 text-sm mt-0 hover:underline cursor-pointer'
                  onClick={() => {
                    router.push(`/profile/${petUsername}`)
                  }}
                >
                  @{comment.pets_username}
                </p>
